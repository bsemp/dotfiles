...
alias akamai-shell='docker run -it --rm -v ${XDG_CONFIG_HOME}/akamai/.edgerc:/root/.edgerc:ro akamai/shell:latest'
alias akamai='docker run -it --rm -v ${XDG_CONFIG_HOME}/akamai/.edgerc:/root/.edgerc:ro akamai/shell:latest akamai'
